              ...
              <div className="space-y-6 pl-2">
                {Object.keys(item.month).map((month, monthIdx) => (
                  <div key={monthIdx} className="relative pl-6">
                    <div className="absolute left-0 top-1.5 w-px h-[calc(100%-0.5rem)] bg-linear-to-b from-primary/60 to-slate-200 dark:to-slate-600" />
                    <div className="absolute -left-1 top-1.5 w-2.5 h-2.5 rounded-full bg-primary shadow-xs ring-2 ring-white dark:ring-black-b" />
